...
<CardGroup cols={3}>
  <Card
    ...
    href="/docs/eleven-creative/playground/speech-to-text"
  >
  ...
  <Card
    title="Developers"
    icon="duotone code"
    href="/docs/eleven-api/guides/cookbooks/speech-to-text"
  >
  ...
  <Card
    ...
    icon="duotone code"
    href="/docs/eleven-api/guides/how-to/speech-to-text/realtime/client-side-streaming"
  >
  ...
  <Card
    ...
    href="/docs/api-reference/speech-to-text/convert"
  >
...
<CardGroup cols={2} rows={1}>
  <Card title="Scribe v2" href="/docs/overview/models#scribe-v2">
    ...
    <div className="mt-4 space-y-2">
      ...
      <div className="text-sm">Keyterm prompting, up to 1000 terms</div>
...
<Info>Keyterm prompting is available with Scribe v2 (batch) and Scribe v2 Realtime.</Info>
...
<Info>No verbatim mode is available with Scribe v2 (batch) and Scribe v2 Realtime.</Info>
